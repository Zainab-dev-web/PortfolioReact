                            ...
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    ...
                                    {none === true ? <div className="alert alert-success alert-dismissible fade show " role="alert" >
                                        <strong>Merci à vous! </strong>Votre demande de devis a bien été envoyé , vous recevrez une réponse dans votre boîte mail , veuillez verifier vos spams et vos courriers indésirables.
